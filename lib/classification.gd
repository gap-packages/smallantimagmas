...
#! <C>"congruences"</C>, the number
#! <Ref Attr="NrCongruences" Label="for IsMagma"/>; a magma is congruence-free
#! precisely when it falls into the column <C>2</C>.
#!
...
#! <C>"congruences"</C> the values that occur among <A>magmas</A>. The rows count
...
#! ------------------------------------
#! Iso+antiiso classes     5    1  3  1
#! ------------------------------------
#! Isomorphism classes    10    2  6  2
#! ....................................
#! 2-iso classes           2    2  0  0
#! 6-iso classes           8    0  6  2
#! ------------------------------------
#! Labelled magmas        52    4 36 12
#! ------------------------------------
