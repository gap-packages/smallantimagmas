gap> START_TEST("tst_cancellativity_properties_magma_cancellativity_degree.tst");
...
gap> STOP_TEST("tst_cancellativity_properties_magma_cancellativity_degree.tst");
