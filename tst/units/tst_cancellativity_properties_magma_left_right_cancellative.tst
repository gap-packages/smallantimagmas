gap> START_TEST("tst_cancellativity_properties_magma_left_right_cancellative.tst");
...
gap> STOP_TEST("tst_cancellativity_properties_magma_left_right_cancellative.tst");
