...
gap> GeneratorPossibleDiagonals(2);  
[ [ 2, 1 ] ]

gap> GeneratorPossibleDiagonals(3);
[ 
    [ 2, 1, 1 ], [ 2, 1, 2 ], 
    [ 2, 3, 1 ], [ 2, 3, 2 ], 
    [ 3, 1, 1 ], [ 3, 1, 2 ], 
...
gap> GeneratorPossibleDiagonals(4);
[ 
...
gap> GeneratorFilterNonIsomorphicMagmas(ReallyAllSmallAntimagmas(3));
[ 
