...
Error, smallantimagmas: <by> must be one of all, diagonal, cancellativity, cancellativity-degree, commutativity, translation, product-set, rank, index-period, mediality, constant
